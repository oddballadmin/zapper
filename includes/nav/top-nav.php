<nav>
    ...
    <li class="nav-item"><a href="" class="nav-link">Report A Bug<?php $pageTitle = "reportAbug"; ?></a></li>
    <li class="nav-item"><a href="" class="nav-link">Create An Account<?php $pageTitle = "createAnAccount"; ?></a></li>
</nav>